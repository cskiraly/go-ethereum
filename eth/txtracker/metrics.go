...
var (
	...
	txEvictedAnnouncedMeter      = metrics.NewRegisteredMeter("eth/txtracker/evicted/announced", nil)
	txEvictedRequestedMeter      = metrics.NewRegisteredMeter("eth/txtracker/evicted/requested", nil)
	txEvictedReceivedMeter       = metrics.NewRegisteredMeter("eth/txtracker/evicted/received", nil)
	txEvictedPooledMeter         = metrics.NewRegisteredMeter("eth/txtracker/evicted/pooled", nil)
	txEvictedIncludedMeter       = metrics.NewRegisteredMeter("eth/txtracker/evicted/included", nil)
	txEvictedFinalizedMeter      = metrics.NewRegisteredMeter("eth/txtracker/evicted/finalized", nil)
	txEvictedRejectedMeter       = metrics.NewRegisteredMeter("eth/txtracker/evicted/rejected", nil)
