...
var (
	...
	// signed by an address which already has in-flight transactions known to
	// the pool.
	ErrAuthorityReserved = errors.New("authority already reserved")

	// ErrFutureReplacePending is returned if a future transaction replaces a
	// pending one. Future transactions should only be able to replace other
	// future transactions.
